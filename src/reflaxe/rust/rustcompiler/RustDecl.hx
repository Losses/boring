...
class RustDecl {
	...
	public function classDecl(cls: ClassType, varFields: Array<ClassVarData>, funcFields: Array<ClassFuncData>): String {
		...
		if(state.recordCloneTypes.exists(cls.module + "::" + cls.name) && !StaticFieldHelper.hasSelfConstructionStatic(cls) && !cls.meta.has(":dataClass") && cls.module.indexOf("registry.") != 0 && isAllClone(varFields) && classParams.length == 0) {
