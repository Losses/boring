...
';
	...
	public static final TEST_SOURCE = [
		...
		'}',
		'',
		'pub fn run<F: FnOnce()>(id: &str, body: F) {',
		...
		'            };',
		'            record_result(id, "fail", Some(&msg));',
		...
		'}',
		'',
		'fn record_result(id: &str, verdict: &str, message: Option<&str>) {',
		...
		'        format!("{{\\\"id\\\":\\\"{}\\\",\\\"verdict\\\":\\\"pass\\\"}}\\n", escape_json(id))',
		'    } else {',
		'        format!("{{\\\"id\\\":\\\"{}\\\",\\\"verdict\\\":\\\"fail\\\",\\\"message\\\":\\\"{}\\\"}}\\n", escape_json(id), escape_json(message.unwrap_or("")))',
		'    };',
