...
class Core {
 ...
 @:noinline static function cargoPath(n:String):String { if(n.length==1) return "1/"; if(n.length==2) return "2/"; if(n.length==3) return "3/"+n.substring(0,1)+"/"; return n.substring(0,2)+"/"+n.substring(2,4)+"/"; }
