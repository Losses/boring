...
extern class Functional {
	...
	public static function associate<T, K, V>(arr:Array<T>, fn:(item:T) -> {final key:K; final value:V;}):std.SortedMap<K, V>;
	...
	public static function groupBy<T, K, V>(arr:Array<T>, fn:(item:T) -> {final key:K; final value:V;}):std.SortedMap<K, Array<V>>;
}
