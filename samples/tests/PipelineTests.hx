...
class PipelineTests {
    ...
    public static function testShadowing():Void {
        var items:Array<Item> = [{id: 1, name: "Alice", score: 10}, {id: 2, name: "Bob", score: 25}];
    ...
    public static function testAssociate():Void {
        ...
        var itemsWithDup:Array<Item> = [{id: 1, name: "First", score: 10}, {id: 1, name: "Updated", score: 20}];
    ...
    public static function testNestedLoop():Void {
        var matrix:Array<Array<Int>> = [[1, 2, 3], [4, 5, 6]];
    ...
    public static function testSumOfFloat():Void {
        ...
        var items:Array<Item> = [{id: 1, name: "Alice", score: 10}, {id: 2, name: "Bob", score: 20}];
