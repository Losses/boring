...
class MathNaNOpsTests {
    ...
    public static function minValues():Void {
        MathNaNTestSupport.assertNaN(MathNaNOps.minOf((0.0 / 0.0), 2.0), "min NaN, finite");
        MathNaNTestSupport.assertNaN(MathNaNOps.minOf(2.0, (0.0 / 0.0)), "min finite, NaN");
        MathNaNTestSupport.assertNaN(MathNaNOps.minOf((0.0 / 0.0), (0.0 / 0.0)), "min NaN, NaN");
        ...
        MathNaNTestSupport.assertNaN(MathNaNOps.minOf((0.0 / 0.0), Math.POSITIVE_INFINITY), "min NaN, infinity");
        MathNaNTestSupport.assertNaN(MathNaNOps.minOf(Math.POSITIVE_INFINITY, (0.0 / 0.0)), "min infinity, NaN");
    ...
    public static function maxValues():Void {
        MathNaNTestSupport.assertNaN(MathNaNOps.maxOf((0.0 / 0.0), 2.0), "max NaN, finite");
        MathNaNTestSupport.assertNaN(MathNaNOps.maxOf(2.0, (0.0 / 0.0)), "max finite, NaN");
        MathNaNTestSupport.assertNaN(MathNaNOps.maxOf((0.0 / 0.0), (0.0 / 0.0)), "max NaN, NaN");
        ...
        MathNaNTestSupport.assertNaN(MathNaNOps.maxOf((0.0 / 0.0), Math.NEGATIVE_INFINITY), "max NaN, infinity");
        MathNaNTestSupport.assertNaN(MathNaNOps.maxOf(Math.NEGATIVE_INFINITY, (0.0 / 0.0)), "max infinity, NaN");
