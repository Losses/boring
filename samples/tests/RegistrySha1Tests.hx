...
class RegistrySha1Tests {
    ...
    public static function hashesBoundaries():Void {
        ...
        Test.equals("ee971065aaa017e0632a8ca6c77bb3bf8b1dfc56",
            Sha1.hex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));
        Test.equals("f34c1488385346a55709ba056ddd08280dd4c6d6",
            Sha1.hex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));
    }
}
