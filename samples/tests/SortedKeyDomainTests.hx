...
class SortedKeyDomainTests {
    ...
    public static function testStructureKeyLookup():Void {
        final hitTag:ClusterTag = {
            name: "alpha",
            score: 10,
            sub: {priority: 1},
            active: true
        };
        final missTag:ClusterTag = {
            name: "alpha",
            score: 10,
            sub: {priority: 99},
            active: true
    ...
    public static function testStructureMapLastWins():Void {
        ...
        final tagA:ClusterTag = {
            name: "tag",
            score: 1,
            sub: {priority: 10},
            active: true
        };
        final tagB:ClusterTag = {
            name: "tag",
            score: 1,
            sub: {priority: 10},
            active: true
    ...
    public static function testStructureSetOperations():Void {
        ...
        Test.equals(true, set.has({
            name: "beta",
            score: 10,
            sub: {priority: 1},
            active: true
        }), "has existing element");
        Test.equals(false, set.has({
            name: "beta",
            score: 10,
            sub: {priority: 1},
            active: false
        }), "has non-existing element");
    }
}
