...
class GraphemeTests {
    ...
    public static function testEmojiSequences():Void {
        final family = UString.fromCodePoint(0x1F468) + UString.fromCodePoint(0x200D) + UString.fromCodePoint(0x1F469) + UString.fromCodePoint(0x200D)
            + UString.fromCodePoint(0x1F467) + UString.fromCodePoint(0x200D) + UString.fromCodePoint(0x1F466);
    ...
    public static function testRegionalIndicators():Void {
        ...
        final chinaJapan = UString.fromCodePoint(0x1F1E8)
            + UString.fromCodePoint(0x1F1F3)
            + UString.fromCodePoint(0x1F1EF)
            + UString.fromCodePoint(0x1F1F5);
    ...
    public static function testDevanagariConjunct():Void {
        ...
        final withExtend = UString.fromCodePoint(0x0915)
            + UString.fromCodePoint(0x094D)
            + UString.fromCodePoint(0x0300)
            + UString.fromCodePoint(0x0915);
    ...
    public static function testSlicing():Void {
        final mixed = UString.fromCodePoint(0x1F44D)
            + UString.fromCodePoint(0x1F3FD)
            + UString.fromCodePoint(0x63D0)
            + UString.fromCodePoint(0x6920);
