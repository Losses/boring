...
class EnumQueriesTests {
	...
	public static function names():Void Test.equals("F64,F32,F16", EnumQueriesOps.names());
	...
	public static function second():Void Test.equals("Read,Write", EnumQueriesOps.secondEnum());
}
