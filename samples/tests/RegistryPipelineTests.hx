...
class RegistryPipelineTests {
    ...
    public static function generatesFiles():Void {
        var records:Array<InputRecord> = [
            ...
            {path: "alice/one/1.0.0/npm/metadata.json", content: '{"name":"one","version":"1.0.0","url":"https://example.test/one.tgz","sha512":"digest"}',
                inputRecord: 1},
            {path: "bob/two/README.md", content: "Two package\n", inputRecord: 1},
            {path: "bob/two/2.0.0/cargo/metadata.json", content: '{"name":"two","version":"2.0.0","url":"https://example.test/two.crate","sha256":"checksum"}',
                inputRecord: 1}
        ];
