...
class RegistryPipelineTests {
 ...
 public static function generatesFiles():Void {
  var records:Array<InputRecord> = [
   {path:"alice/one/1.0.0/README.md", content:"One package\n", inputRecord:1},
   ...
   {path:"bob/two/2.0.0/README.md", content:"Two package\n", inputRecord:1},
  ...
  var expected:Array<OutputFile> = [
   ...
   {path:"cargo/index/2/two", content:'{"name":"two","vers":"2.0.0","deps":[],"cksum":"checksum","features":{},"yanked":false,"v":2}\n', outputFile:1},
