...
class PrintedSortedFields {
    ...
    public function new(marks:SortedSet<Int>, points:SortedSet<PrintedPoint>, lookup:SortedMap<String, Int>, emptySet:SortedSet<Int>,
            emptyMap:SortedMap<String, Int>) {
        this.marks = marks;
        this.points = points;
        this.lookup = lookup;
...
class PrintedNullableMark {
    ...
    public function new(mark:Null<PrintedMark>) {
        this.mark = mark;
    }
}
