...
class FramePolicy {
    ...
    public function valueCountText():String
...
class ConstructedStateOps {
    public static function labels():String {
        return FramePolicy.weighted.label
            + ","
            + FramePolicy.plain.label
            + ","
            + FramePolicy.imported.label
            + ","
            + FramePolicy.generated.label;
    }
    ...
    public static function crossClassText():String
        return BuiltInFrame.frame.label;

    public static function generatedLabel():String
        return FramePolicy.generated.label;
}
