...
abstract Int64(Int64Repr) {
    private function new(value:Int64Repr)
        this = value;

    public static function make(high:Int, low:Int):Int64
        return new Int64(new Int64Repr(high, low));

    @:from public static function ofInt(value:Int):Int64
        return make(value >> 31, value);

    public static function getHigh(value:Int64):Int
        return value.high;

    public static function getLow(value:Int64):Int
        return value.low;
    ...
    @:op(A * B) public static function mul(a:Int64, b:Int64):Int64
        return make(0, 0);

    @:op(A * B) @:commutative public static function mulInt(a:Int64, b:Int):Int64
        return make(0, 0);
    ...
    @:op(~A) public static function complement(a:Int64):Int64
        return make(0, 0);
    ...
    @:op(A < B) public static function lt(a:Int64, b:Int64):Bool
        return false;

    @:op(A > B) public static function gt(a:Int64, b:Int64):Bool
        return false;

    @:op(A <= B) public static function lte(a:Int64, b:Int64):Bool
        return false;

    @:op(A >= B) public static function gte(a:Int64, b:Int64):Bool
        return false;
    ...
    private function set_high(value:Int):Int
    ...
    private function set_low(value:Int):Int
