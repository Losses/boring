...
class RustTestBinding {
 ...
 public static function shimModule(): String return externModules()[0];
 public static function externModules(): Array<String> return RuntimeResidents.externsOf("runtime.TestCore");
 public static function externModule(): String return externModules()[0];
 public static function shimPath(): String return "test.rs";
}
#end
