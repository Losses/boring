    ...
    **/
    function stringViewArg(arg:TypedExpr):String {
        ...
        return switch (stripWrap(arg).expr) {
            ...
            case _:
                if (!StringTools.startsWith(rendered, "UString::from(") && (StringTools.contains(rendered, ".to_string()") || StringTools.contains(rendered, "String::new()")
            ...
            if (i < paramTypes.length) {
                ...
                if (isNullType(pt) && isNullType(arg.t)
                    ...
                    if (isStringType(inner) && !StringTools.endsWith(argStr, ".to_ustring()"))
                        out.push("Some(" + argStr + ".to_ustring())");
                ...
                if (isNullType(pt) && !isNullType(arg.t)) {
                    ...
                    final inner = switch (stripWrap(arg).expr) {
                        ...
                        case _ if (isStringType(getNullInnerType(pt)) && isStringType(arg.t)):
                            StringTools.endsWith(argStr, ".to_ustring()") ? argStr : "(" + argStr + ").to_ustring()";
                ...
                if (stringLikeType(pt) && stringLikeType(arg.t)) {
                    out.push(switch (stripWrap(arg).expr) {
                        ...
                        case _: if (!StringTools.startsWith(argStr, "UString::from(") && (StringTools.contains(argStr, ".to_string()") || StringTools.contains(argStr, "String::new()") || StringTools.startsWith(argStr, "format!") || StringTools.endsWith(argStr, ".name())")) "&UString::from((" + argStr + ").as_str())" else argStr + ".as_ustr()";
                    });
                    continue;
                }
