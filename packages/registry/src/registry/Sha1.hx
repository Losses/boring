...
class Sha1 {
    public static function hex(text:String):String {
        ...
        i = 0;
        while (i < 8) {
            data[size - 1 - i] = i < 4 ? (bitLength >>> (i * 8)) & 255 : 0;
            i = i + 1;
        }
        var h0 = 0x67452301,
            h1 = 0xEFCDAB89,
    ...
    static function utf8(text:String):Array<Int> {
        ...
        while (i < text.length) {
            ...
            if (c < 0x80)
                ...
                out.push(0x80 | ((code >> 12) & 63));
                out.push(0x80 | ((code >> 6) & 63));
                out.push(0x80 | (code & 63));
            } else {
                out.push(0xE0 | (c >> 12));
    ...
    static function rol(x:Int, n:Int):Int
        return (x << n) | (x >>> (32 - n));
