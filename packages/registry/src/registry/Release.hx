...
class Release {
 public var owner:String; public var repo:String; public var version:String; public var name:String; public var license:Null<String>; public var readme:String; public var platform:String; public var url:Null<String>; public var digest:String; public var archive:Null<String>; public var packageSwift:Null<String>; public var pubspec:Null<registry.Json.JsonValue>; public var groupId:Null<String>; public var artifacts:Array<String>; public var artifactUrls:Array<String>;
