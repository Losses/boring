...
| 26 | [26-package-registry.md](features/26-package-registry.md) | Planned | The publish manager: it scans the GitHub releases of a repository list and generates one static registry site, with artifacts served from release assets and object storage and only documents on the site. |
