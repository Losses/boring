...
describe("package shell emission", () => {
  ...
  test("the Swift, Kotlin, and Rust manifests of the reference trees are pinned", () => {
    ...
    expect(swiftPackage).toContain('name: "BoringSwiftTestsF32"');
    ...
    expect(fs.readFileSync(path.join(REPO_ROOT, "reference/rust/gen/Cargo.toml"), "utf8")).toBe([
    ...
    expect(fs.readFileSync(path.join(REPO_ROOT, "reference/rust-f32/gen/Cargo.toml"), "utf8")).toBe([
      "# Generated by the reflaxe Rust target. Do not edit.",
      "[package]",
