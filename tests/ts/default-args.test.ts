...
describe("default argument expansion generated tree", () => {
  ...
  test("Swift generated tree lowers parameter-reading coalescing defaults in the body", () => {
    ...
    expect(content).toContain("public func instanceFieldNormalization(_ p: String? = Optional<String>.none) -> String");
    expect(content).toContain("public func earlierLocalNormalization(_ seed: String, _ q: String? = Optional<String>.none) -> String");
